...
var ListItemComponent = /** @class */ (function () {
    function ListItemComponent(router, multilevelMenuService) {
        ...
        this.selectedListClasses = (_a = {},
            _a[_constants__WEBPACK_IMPORTED_MODULE_3__["CONSTANT"].DEFAULT_LIST_CLASS_NAME] = true,
            _a[_constants__WEBPACK_IMPORTED_MODULE_3__["CONSTANT"].SELECTED_LIST_CLASS_NAME] = false,
            _a[_constants__WEBPACK_IMPORTED_MODULE_3__["CONSTANT"].ACTIVE_ITEM_CLASS_NAME] = false,
            _a);
    }
    ...
    ListItemComponent.prototype.setSelectedClass = function (isFound) {
        ...
        this.selectedListClasses = (_a = {},
            _a[_constants__WEBPACK_IMPORTED_MODULE_3__["CONSTANT"].DEFAULT_LIST_CLASS_NAME] = true,
            _a[_constants__WEBPACK_IMPORTED_MODULE_3__["CONSTANT"].SELECTED_LIST_CLASS_NAME] = this.isSelected,
            _a[_constants__WEBPACK_IMPORTED_MODULE_3__["CONSTANT"].ACTIVE_ITEM_CLASS_NAME] = this.selectedNode.id === this.node.id,
            _a[_constants__WEBPACK_IMPORTED_MODULE_3__["CONSTANT"].DISABLED_ITEM_CLASS_NAME] = this.node.disabled,
    ...
    ListItemComponent.prototype.dividerEnabled = function () {
...
var routes = [{
        path: '',
        loadChildren: function () { return __webpack_require__.e(/*! import() | src-app-pages-pages-module */ "src-app-pages-pages-module").then(__webpack_require__.bind(null, /*! src/app/pages/pages.module */ "./src/app/pages/pages.module.ts")).then(function (m) { return m.PagesModule; }); }
    }, {
        path: '',
        redirectTo: '/',
        pathMatch: 'full'
...
var AppComponent = /** @class */ (function () {
    function AppComponent(iconRegistry, sanitizer, router) {
        var _this = this;
    ...
    AppComponent.prototype.selectedItem = function ($event) {
        console.log($event);
    };
    AppComponent.prototype.selectedLabel = function ($event) {
        console.log($event);
    };
